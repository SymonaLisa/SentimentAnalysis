...
export const TestDataLoader: React.FC<TestDataLoaderProps> = ({ 
  ...
  const categories = ['all', 'product_review', 'service_review', 'entertainment', 'general'];
  const difficulties = ['all', 'easy', 'medium', 'hard'];
  const sources = ['all', 'Specified Test Data'];
      ...
      {showStats && (
        <div className="mb-6 p-4 bg-purple-50 rounded-lg border border-purple-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            ...
            <div>
              <div className="font-semibold text-purple-800">Difficulties</div>
              <div className="text-purple-600">{Object.keys(stats.byDifficulty).length}</div>
            </div>
            <div>
              <div className="font-semibold text-purple-800">Sources</div>
              <div className="text-purple-600">{Object.keys(stats.bySource).length}</div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="Specified Test Data">Specified Test Data</option>
            </select>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-bold text-purple-600">
                {filteredData.filter(d => d.source === 'Specified Test Data').length}
              </div>
              <div className="text-sm text-gray-600">Specified</div>
            </div>
          </div>
        </div>
