...
export const sentimentTestData: TestDataEntry[] = [
  // PDF Test Data - Positive Examples
  {
    id: 'pdf_pos_1',
  ...
  // PDF Test Data - Negative Examples
  {
    id: 'pdf_neg_1',
  ...
  // PDF Test Data - Neutral Examples
  {
    id: 'pdf_neu_1',
  ...
  // PDF Test Data - Complex/Challenging Examples
  {
    id: 'pdf_complex_1',
  ...
  // Additional Enhanced Dataset Examples
  {
    id: 'enhanced_pos_1',
    text: 'Love it!',
    expectedSentiment: 'positive',
...
// Get only PDF test data
export const getPDFTestData = (): TestDataEntry[] => {
  return sentimentTestData.filter(entry => entry.source === 'PDF Test Data');
};
